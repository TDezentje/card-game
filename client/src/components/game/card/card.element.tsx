...
export function CardElement({
    ...
    return <Watch property={card} render={card => 
        <div class={`${css.cardContainer} ${onClick ? css.clickable : ''} ${isMine ? css.mine : ''} ${gameState.status === GameStatus.cleanup ? css.cleanup : ''}`} 
            style={{
